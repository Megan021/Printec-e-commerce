...
const CustomProduct = () => {
    return (
        <div>
            <div className="h-[40vh] lg:h-[55vh] bg-[url('./assets/footer2.jpg')] flex bg-center bg-cover bg-no-repeat justify-center text-center items-center text-white">
                <div className="group lg:w-[27%]">
                    <h3 className="uppercase font-semibold text-xs pb-5">100% Solid Printing</h3>
                    <p className="font-semibold text-2xl px-5 lg:text-4xl pb-9">Ready to create some custom products?</p>
